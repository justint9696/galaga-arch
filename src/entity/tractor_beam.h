...
#define TRACTOR_BEAM_FLAGS              (FLAG_PARENT_REF)
...
void tractor_beam_init(Entity *, World *);
void tractor_beam_collide(Entity *, Entity *, World *);
void tractor_beam_update(Entity *, World *);
void tractor_beam_destroy(Entity *, World *);
